...
public class CheckoutController : BaseTraceController
{
    private readonly EfCoreContext _context;
        ...
        public CheckoutController(EfCoreContext context) => _context = context;
        ...
        {
            var cookie = new BasketCookie(HttpContext.Request.Cookies, HttpContext.Response.Cookies);  //#B
