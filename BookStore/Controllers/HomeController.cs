...
public class HomeController : BaseTraceController
{
    ...
    public HomeController(EfCoreContext context) => _context = context;
    ...
    /*******************************************************
        ...
        * *****************************************************/
        ...
        /// <returns></returns>
        [HttpGet]
        public JsonResult GetFilterSearchContent (SortFilterPageOptions options) //#B
        {
            var service = new BookFilterDropdownService(_context); //#C

            var traceIdent = HttpContext.TraceIdentifier; //REMOVE THIS FOR BOOK as it could be confusing

            return Json( //#D
                new TraceIndentGeneric<IEnumerable<DropdownTuple>>(
                    traceIdent, service.GetFilterDropDownValues( //#E
                        options.FilterBy))); //#E
        }
        /****************************************************
