...
public class ChangePubDateService : IChangePubDateService
{
    ...
    public ChangePubDateService(EfCoreContext context) => _context = context; //#B
    ...
    public Book UpdateBook(ChangePubDateDto dto)       //#F
    {
        ...
        if (book == null)                              //#H
            throw new ArgumentException("Book not found");                     //#H
...
/*********************************************************
    #A This interface is needed when registering this class in DI.
